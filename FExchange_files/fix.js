...
textarea.val(textarea.val().replace(/ଊଧ/g,"ଊର୍ଦ୍ଧ୍ବ"));textarea.val(textarea.val().replace(/ଊର୍ଧ/g,"ଊର୍ଦ୍ଧ୍ବ")); textarea.val(textarea.val().replace(/ଊଧ୍ବ/g,"ଊର୍ଦ୍ଧ୍ବ")); textarea.val(textarea.val().replace(/ଊର୍ଧ୍ବ/g,"ଊର୍ଦ୍ଧ୍ବ")); textarea.val(textarea.val().replace(/ଊର୍ଦ୍ଧ୍ବ୍ବ/g,"ଊର୍ଦ୍ଧ୍ବ"));
