$(document).ready(function() {
    ...
    $("#weather").click(function(event) {
        $("#dipslay_result").html('<h3 align="center"><img src="https://www.expoodisha.com/images/loading.gif" border="0" width="16" height="16" alt="Loading..."> Loading...</h3>');
        var citi = $("#url_id").val();
...
$(document).ready(function() {
    $("#subscribe").click(function() {
        ...
        $.ajax({
            type: "get",
            url: "https://www.expoodisha.com/html/subscribe.php",
            data: {
                signurl: myurl,
                signup: email
            },
...
$(document).ready(function() {
    $('#uInput').keyup(function() {
        ...
        var wc = txt;
        var lc = lin;
        $('#cc_data').html('Total Characters: <mark>[' + ch + ']</mark>, Total Words: <mark>[' + wc + ']</mark> and Line Count: <mark>[' + lc + ']</mark>');
    });
});
...
$(document).ready(function() {
    ...
    $("#gen_imdb").click(function() {
		...
		$.getJSON('https://www.omdbapi.com/?t=' + movie, function(md) {
			...
			if (Poster == 'N/A' || !Poster) {Poster = 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/ac/No_image_available.svg/300px-No_image_available.svg.png';}
...
$(document).ready(function() {
    ...
    $("#addbtn").click(function() {
        if (counter > 200) {
            alert("Only 150 textboxes allowed");
            return false;
        }
        ...
        newTextBoxDiv.after().html('<label for="name" class="col-lg-2 control-label">Word #' + counter + ' :</label>' + '<div class="col-lg-4"><input type="text" class="form-control input-sm" placeholder="Find #' + counter + '" id="findbox' + counter + '"></div>' + '<label for="name" class="col-lg-2 control-label">Exc #' + counter + ' :</label>' + '<div class="col-lg-4"><input type="text" class="form-control input-sm" placeholder="Replace #' + counter + '" id="replacebox' + counter + '"></div>');
...
$(document).ready(function() {
    $("#driver").click(function(event) {
        $("#youtube_screenshot").html('<h4 align="center"><img src="https://www.expoodisha.com/images/loading.gif" width="16" height="16" alt="Loading..."> Loading! Please Wait...</h4>');
...
$(document).ready(function() {
    $('#viewsource').click(function() {
        ...
        for (var i = 0; i < lines.length; i++) {
            if (/\S/.test(lines[i])) {
                window.open('https://www.expoodisha.com/tools/support/print-code.html?v=' + lines[i]);
            }
        }
		return false;
    });
...
$(document).ready(function() {
    $("#pingxml").click(function() {
		$('#postping').html('<pre class="text-center"><img src="https://www.expoodisha.com/images/loading.gif" width="16" height="16" alt="Loading..."> Loading...</pre>');
		var url_id = $("#url").val();
			$.ajax({
				type: "post",
				url: "https://www.expoodisha.com/tools/support/ping-print.html",
				data: {
					url_id: url_id
				},
				cache: false,
...
$(document).ready(function() {
    $("#screenshot").click(function(event) {
        $("#MbSs").html('<div class="text-center"><h3><img src="https://www.expoodisha.com/images/loading.gif" border="0" width="16" height="16" alt="Loading..."> Please Wait...</h3>While we are preparing the <b>Mobile</b> screenshots.<br><br></div>');
        $("#DtSs").html('<div class="text-center"><h3><img src="https://www.expoodisha.com/images/loading.gif" border="0" width="16" height="16" alt="Loading..."> Please Wait...</h3>While we are preparing the <b>Desktop</b> screenshots.<br><br></div>');
...
$(document).ready(function() {
    ...
    $("#pagespeed").click(function(event) {
        $("#result_pagespeed").html('<div class="text-center"><h3><img src="https://www.expoodisha.com/images/loading.gif" border="0" width="16" height="16" alt="Loading..."> Please Wait...</h3>While we are preparing your report.<br><br></div>');
        var PS_URL = $("#url_id").val();
